...
define("ClientInfo", ["require", "exports", "Utils"], function (require, exports, Utils_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
    * @hidden
...
define("IdToken", ["require", "exports", "Utils"], function (require, exports, Utils_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
    * @hidden
    ...
    var IdToken = (function () {
        function IdToken(rawIdToken) {
            ...
            try {
                ...
                var decodedIdToken = Utils_2.Utils.extractIdToken(rawIdToken);
                if (decodedIdToken) {
...
define("User", ["require", "exports", "Utils"], function (require, exports, Utils_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var User = (function () {
        /**
        ...
        */
        User.createUser = function (idToken, clientInfo, authority) {
            ...
            var userIdentifier = Utils_3.Utils.base64EncodeStringUrlSafe(uid) + "." + Utils_3.Utils.base64EncodeStringUrlSafe(utid);
...
define("ITenantDiscoveryResponse", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
});
define("ErrorMessage", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
    * @hidden
...
define("XhrClient", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
...
define("Authority", ["require", "exports", "Utils", "ErrorMessage", "XhrClient"], function (require, exports, Utils_4, ErrorMessage_1, XhrClient_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    ...
    var Authority = (function () {
        ...
        Object.defineProperty(Authority.prototype, "CanonicalAuthority", {
            ...
            */
            ...
            set: function (url) {
                this.canonicalAuthority = Utils_4.Utils.CanonicalizeUri(url);
        ...
        Object.defineProperty(Authority.prototype, "CanonicalAuthorityUrlComponents", {
            get: function () {
                if (!this.canonicalAuthorityUrlComponents) {
                    this.canonicalAuthorityUrlComponents = Utils_4.Utils.GetUrlComponents(this.CanonicalAuthority);
                }
...
define("AadAuthority", ["require", "exports", "Authority", "XhrClient"], function (require, exports, Authority_1, XhrClient_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
    * @hidden
    ...
    var AadAuthority = (function (_super) {
        ...
        */
        AadAuthority.prototype.GetOpenIdConfigurationEndpointAsync = function () {
            ...
            var client = new XhrClient_2.XhrClient();
...
define("AccessTokenKey", ["require", "exports", "Utils"], function (require, exports, Utils_5) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
    * @hidden
    */
    var AccessTokenKey = (function () {
        function AccessTokenKey(authority, clientId, scopes, uid, utid) {
            ...
            this.scopes = scopes;
            this.userIdentifier = Utils_5.Utils.base64EncodeStringUrlSafe(uid) + "." + Utils_5.Utils.base64EncodeStringUrlSafe(utid);
        }
        return AccessTokenKey;
    }());
    exports.AccessTokenKey = AccessTokenKey;
});
define("AccessTokenValue", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
    * @hidden
...
define("AccessTokenCacheItem", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
    * @hidden
...
define("AuthenticationRequestParameters", ["require", "exports", "Utils"], function (require, exports, Utils_6) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
    * @hidden
    */
    var AuthenticationRequestParameters = (function () {
        function AuthenticationRequestParameters(authority, clientId, scope, responseType, redirectUri) {
            ...
            this.correlationId = Utils_6.Utils.createNewGuid();
            this.state = Utils_6.Utils.createNewGuid();
            this.nonce = Utils_6.Utils.createNewGuid();
            // telemetry information
            this.xClientSku = "MSAL.JS";
            this.xClientVer = Utils_6.Utils.getLibraryVersion();
        }
...
define("B2cAuthority", ["require", "exports", "AadAuthority", "Authority", "Utils", "ErrorMessage"], function (require, exports, AadAuthority_1, Authority_2, Utils_7, ErrorMessage_2) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
    * @hidden
    */
    var B2cAuthority = (function (_super) {
        ...
        function B2cAuthority(authority, validateAuthority) {
            ...
            var urlComponents = Utils_7.Utils.GetUrlComponents(authority);
            var pathSegments = urlComponents.PathSegments;
            if (pathSegments.length < 3) {
                throw ErrorMessage_2.ErrorMessage.b2cAuthorityUriInvalidPath;
            }
        ...
        */
        B2cAuthority.prototype.GetOpenIdConfigurationEndpointAsync = function () {
            ...
            return new Promise(function (resolve, reject) {
                return reject(ErrorMessage_2.ErrorMessage.unsupportedAuthorityValidation);
            });
        };
        return B2cAuthority;
...
define("AuthorityFactory", ["require", "exports", "Utils", "AadAuthority", "B2cAuthority", "Authority", "ErrorMessage"], function (require, exports, Utils_8, AadAuthority_2, B2cAuthority_1, Authority_3, ErrorMessage_3) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var AuthorityFactory = (function () {
        ...
        */
        AuthorityFactory.DetectAuthorityFromUrl = function (authorityUrl) {
            authorityUrl = Utils_8.Utils.CanonicalizeUri(authorityUrl);
            var components = Utils_8.Utils.GetUrlComponents(authorityUrl);
            var pathSegments = components.PathSegments;
            switch (pathSegments[0]) {
                case "tfp":
                    return Authority_3.AuthorityType.B2C;
                case "adfs":
                    return Authority_3.AuthorityType.Adfs;
                default:
                    return Authority_3.AuthorityType.Aad;
            }
        };
        /*
        ...
        */
        AuthorityFactory.CreateInstance = function (authorityUrl, validateAuthority) {
            ...
            switch (type) {
                case Authority_3.AuthorityType.B2C:
                    return new B2cAuthority_1.B2cAuthority(authorityUrl, validateAuthority);
                case Authority_3.AuthorityType.Aad:
                    return new AadAuthority_2.AadAuthority(authorityUrl, validateAuthority);
                default:
                    throw ErrorMessage_3.ErrorMessage.invalidAuthorityType;
            }
        };
...
define("Logger", ["require", "exports", "Utils"], function (require, exports, Utils_9) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var LogLevel;
    (function (LogLevel) {
    ...
    var Logger = (function () {
        ...
        */
        Logger.prototype.logMessage = function (logMessage, logLevel, containsPii) {
            ...
            var log;
            if (!Utils_9.Utils.isEmpty(this.correlationId)) {
                log = timestamp + ":" + this._correlationId + "-" + Utils_9.Utils.getLibraryVersion() + "-" + LogLevel[logLevel] + " " + logMessage;
            }
            else {
                log = timestamp + ":" + Utils_9.Utils.getLibraryVersion() + "-" + LogLevel[logLevel] + " " + logMessage;
            }
...
define("RequestContext", ["require", "exports", "Logger"], function (require, exports, Logger_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
    * @hidden
...
define("RequestInfo", ["require", "exports"], function (require, exports) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    /**
    * @hidden
    ...
    var UserAgentApplication = (function () {
        ...
        */
        ...
        UserAgentApplication.prototype.promptUser = function (urlNavigate) {
            if (urlNavigate && !Utils_10.Utils.isEmpty(urlNavigate)) {
        ...
        UserAgentApplication.prototype.getCachedToken = function (authenticationRequest, user) {
            ...
            if (!authenticationRequest.authority) {
                ...
                for (var i = 0; i < tokenCacheItems.length; i++) {
                    ...
                    if (Utils_10.Utils.containsScope(cachedScopes, scopes)) {
                ...
                for (var i = 0; i < tokenCacheItems.length; i++) {
                    var cacheItem = tokenCacheItems[i];
                    var cachedScopes = cacheItem.key.scopes.split(" ");
                    if (Utils_10.Utils.containsScope(cachedScopes, scopes) && cacheItem.key.authority === authenticationRequest.authority) {
                        filteredItems.push(cacheItem);
                    }
                }
                //no match
            ...
            if (accessTokenCacheItem != null) {
                ...
                if (expired && (expired > Utils_10.Utils.now() + offset)) {
                    return {
                        errorDesc: null,
       ...
       */
        ...
        */
        UserAgentApplication.prototype.addHintParameters = function (urlNavigate, user) {
            ...
            var uid = Utils_10.Utils.base64DecodeStringUrlSafe(decodedClientInfo[0]);
            var utid = Utils_10.Utils.base64DecodeStringUrlSafe(decodedClientInfo[1]);
            if (userObject.displayableId && !Utils_10.Utils.isEmpty(userObject.displayableId)) {
                urlNavigate += '&login_hint=' + encodeURIComponent(user.displayableId);
            }
            if (!Utils_10.Utils.isEmpty(uid) && !Utils_10.Utils.isEmpty(utid)) {
                if (!this.urlContainsQueryStringParameter("domain_req", urlNavigate) && !Utils_10.Utils.isEmpty(utid)) {
                    urlNavigate += '&domain_req=' + encodeURIComponent(utid);
                }
                if (!this.urlContainsQueryStringParameter("login_req", urlNavigate) && !Utils_10.Utils.isEmpty(uid)) {
                    urlNavigate += '&login_req=' + encodeURIComponent(uid);
                }
                if (!this.urlContainsQueryStringParameter("domain_hint", urlNavigate) && !Utils_10.Utils.isEmpty(utid)) {
            ...
            if (tokenResponse.parameters.hasOwnProperty("scope")) {
                ...
                for (var i = 0; i < accessTokenCacheItems.length; i++) {
                    ...
                    if (accessTokenCacheItem.key.userIdentifier === user.userIdentifier) {
                        ...
                        if (Utils_10.Utils.isIntersectingScopes(cachedScopes, consentedScopes))
                ...
                if (tokenResponse.stateMatch) {
                    ...
                    if (tokenResponse.parameters.hasOwnProperty(Constants_2.Constants.accessToken)) {
                        ...
                        if (!Utils_10.Utils.isEmpty(this._cacheStorage.getItem(acquireTokenUserKey))) {
                            ...
                            if (user && acquireTokenUser && Utils_10.Utils.compareObjects(user, acquireTokenUser)) {
...
define("index", ["require", "exports", "UserAgentApplication"], function (require, exports, UserAgentApplication_1) {
    "use strict";
    function __export(m) {
        for (var p in m) if (!exports.hasOwnProperty(p)) exports[p] = m[p];
    }
    Object.defineProperty(exports, "__esModule", { value: true });
    __export(UserAgentApplication_1);
});
//# sourceMappingURL=msalx.js.map